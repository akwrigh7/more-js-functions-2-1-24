...
function addTheValues(param1, param2){
    if (isNaN(param1) || isNaN(param2)){
        ...
        addToPage("Both of the paramaters are numbers and when added they equal: " + (param1 + param2));
    }
}
...
addToPage("The current scoere is: " + score);
scoreBasket();
scoreBasket();
...
console.log("number initialized: ", number);
doubleMyNumber(number);
console.log("number after call to doubleMyNumber()");
